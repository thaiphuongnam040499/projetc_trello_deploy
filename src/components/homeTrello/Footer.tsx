...
export default function Footer() {
  return (
    <div>
      <footer
        className="bg-light text-center text-lg-start w-100"
        style={{ bottom: 0 }}
      >
        {/* Copyright */}
        <div className="p-4" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
          <div className="d-flex justify-content-around">
            <div className="trello-logo-footer me-3">
              <svg
                ...
                className="Logo-sc-1anfgcw-0 gguOta trello-logo-footer"
              >
                <defs>
                  <linearGradient
            ...
            <div className="me-3">
              <h6>Tìm hiểu về trello</h6>
              <p>Công nghệ nền tảng</p>
            </div>
            <div className="me-3">
              <h6>Việc làm</h6>
              <p>Tìm hiểu về các vai trò chưa ai đảm nhiệm trong nhóm Trello</p>
            </div>
            <div className="me-3">
              <h6>Ứng dụng</h6>
              <p>
            ...
            <div className="me-3">
              ...
              <p>Bạn cần giúp đỡ hãy liên lạc để chúng tôi có thể trợ giúp</p>
            </div>
          </div>
          <p className="text-center">Bản quyền © 2023 Atlassian</p>
        </div>
        {/* Copyright */}
      </footer>
    </div>
